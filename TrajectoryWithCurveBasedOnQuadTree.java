...
public class TrajectoryWithCurveBasedOnQuadTree extends Canvas
{
    ...
    private QuadTree qt;
     ...
     public TrajectoryWithCurveBasedOnQuadTree(LinkedList < BaryCentricPoint > points,QuadTree qt) {
        this.points = points;
        this.qt = qt;
    }
    ...
    public static void main(String args[]) {
        ...
        LinkedList < BaryCentricPoint > trajectory = qt.visitAllPointsIncludingEmptyTriangles();
        TrajectoryWithCurveBasedOnQuadTree tqt = new TrajectoryWithCurveBasedOnQuadTree(trajectory,qt);
        JFrame f=new JFrame();  
        f.add(tqt);  
